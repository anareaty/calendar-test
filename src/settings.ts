...
import { DEFAULT_WEEK_FORMAT, DEFAULT_WORDS_PER_DOT, DEFAULT_MONTHLY_DAY_FORMAT, DEFAULT_MONTH_FORMAT } from "src/constants";
...
export const defaultSettings = Object.freeze({
  ...
  weeklyNoteFolder: "",
  monthlyNoteFolder: "",
  monthlyDayFormat: DEFAULT_MONTHLY_DAY_FORMAT, 
  monthlyNoteFormat: DEFAULT_MONTH_FORMAT,
...
export class CalendarSettingsTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    this.addMonthlyFolderSetting();
    this.addMonthlyNoteFormatSetting();
    this.addMonthlyDayFormatSetting();
  ...
  addMonthlyDayFormatSetting(): void {
    new Setting(this.containerEl)
      .setName("Monthly day heading format")
      .setDesc("For more syntax help, refer to format reference")
      .addText((textfield) => {
        textfield.setValue(this.plugin.options!.monthlyDayFormat);
        textfield.setPlaceholder(DEFAULT_MONTHLY_DAY_FORMAT);
        textfield.onChange(async (value) => {
          this.plugin.writeOptions(() => ({ monthlyDayFormat: value }));
        });
      });
  }
